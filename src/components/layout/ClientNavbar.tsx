...
export function ClientNavbar({ user, profile }: ClientNavbarProps) {
          ...
          <div className="flex items-center gap-2">
            ...
            {user && profile ? (
              ...
              <div className="hidden sm:flex items-center gap-2">
                ...
                <Link href="/register" className="text-sm font-medium bg-brand-red text-white px-3 py-1.5 rounded-lg hover:bg-brand-red-light transition-colors">
                  Sign Up
                </Link>
              </div>
            )}
        ...
        {isMobileNavOpen && (
          <div className="md:hidden pb-4 border-t border-surface-border mt-1 pt-3 animate-fade-up">
            <ul className="space-y-1">
              ...
              {!user && (
                <li className="pt-2 border-t border-surface-border mt-2 space-y-2">
                  <Link
                    href="/login"
                    className="block px-4 py-3 text-center rounded-lg text-sm font-medium bg-surface-elevated text-white hover:bg-surface-elevated/80 transition-colors"
                  >
                    Login
                  </Link>
                  <Link
                    href="/register"
                    className="block px-4 py-3 text-center rounded-lg text-sm font-medium bg-brand-red text-white hover:bg-brand-red-light transition-colors"
                  >
                    Sign Up
                  </Link>
                </li>
